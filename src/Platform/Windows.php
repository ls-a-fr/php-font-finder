<?php
/*
 * This file includes original work licensed to the ASF: the getWinDirectories() method.
 * Modifications to this code include:
 * - Changed detection disks from C:, D: and E: to A:, B:, C:, D:, E:
 * - Add PowerShell process to get disks if available
 * 
