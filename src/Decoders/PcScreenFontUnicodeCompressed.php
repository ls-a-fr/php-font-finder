...
/**
 * PcScreenFont Unicode, but Gunzipped
 */
class PcScreenFontUnicodeCompressed implements FontDecoder
{
    public static function canExecute(string $raw): bool
    {
        try {
            ...
            return PcScreenFontUnicode::canExecute($decoded);
        } catch (ZlibException) {
    ...
    public static function extractFontMeta(string $raw, string $filename): array
    {
        ...
        return PcScreenFontUnicode::extractFontMeta($decoded, $filename);
    }
}
