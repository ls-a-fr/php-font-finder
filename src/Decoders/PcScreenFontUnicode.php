...
/**
 * Pc Screen Font format (PSF), in an unicode flavor
 *
 * @see https://en.wikipedia.org/wiki/PC_Screen_Font
 */
class PcScreenFontUnicode implements FontDecoder
{
    ...
    {
        // PSFU files have no style definition.
        $name = DecoderUtils::getFontNameFromFilePath($filename, 'psfu');
        $bold = false;
        $italic = false;
        $weight = 400;
